    ...
    <Jumbotron id="aboutme" className="m-0">
      <div className="container row">
        ...
        <div className={`col-lg-${showPic ? "7" : "12"}`}>
          ...
          <p className="lead text-left">{"My name is Weishun Zhong and I am a Ph.D. student in physics at MIT. I am fortunate to be supervised by "} 
          ...
          {"Before my journey in statistical physics, I was an undergraduate student at University of Michigan-Ann Arbor working in high energy theory with "}<a href="https://scholar.google.com/citations?user=h31FiQgAAAAJ&hl=en">James Liu</a>{"."}
          </p>
