  ...
  return (
    <Jumbotron id="aboutme" className="m-0">
      <div className="container row">
        <div className="col-12 col-lg-5 align-self-center text-center text-lg-start">
          {showPic && (
            <img
              className="border border-secondary rounded-circle about-profile-pic"
              src={profilePicUrl}
              alt="profilepicture"
              width={imgSize}
              height={imgSize}
        ...
        <div className={`col-lg-${showPic ? "7" : "12"}`}>
          ...
          <p className="lead text-left">{"Hi! I am currently a postdoctoral "}
          <a href="https://www.ias.edu/scholars/weishun-zhong" target="_blank">member</a> {"at the Institute for Advanced Study, Princeton, working with "}<a href="https://en.wikipedia.org/wiki/Misha_Tsodyks" target="_blank">Misha Tsodyks</a>{"."}<p></p> 
          ...
          {"During my time at MIT and Harvard, I also enjoyed collaborations with and guidances from many great people, including "} <a href="https://ramismovassagh.wordpress.com/" target="_blank">Ramis Movassagh</a>{", "} <a href="https://en.wikipedia.org/wiki/Susanne_Yelin" target="_blank">Susanne Yelin</a>{", "}
